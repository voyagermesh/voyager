...
require (
	...
	github.com/grpc-ecosystem/grpc-gateway v0.0.0-00010101000000-000000000000 // indirect
	...
	kmodules.xyz/openshift v0.0.0-20190225002038-ca9787d09794 // indirect
