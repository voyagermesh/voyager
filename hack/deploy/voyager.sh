...
export VOYAGER_IMAGE_TAG=7.1.0
export VOYAGER_HAPROXY_IMAGE_TAG=1.8.9-7.1.0-alpine
...
export SCRIPT_LOCATION="curl -fsSL https://raw.githubusercontent.com/appscode/voyager/7.1.0/"
...
show_help() {
    ...
    echo "    --haproxy-image-tag            tag of Docker image containing HAProxy binary (default: 1.8.9-7.1.0-alpine)"
