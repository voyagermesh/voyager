...
export VOYAGER_IMAGE_TAG=7.4.0
export VOYAGER_HAPROXY_IMAGE_TAG=1.8.12-7.4.0-alpine
...
show_help() {
  ...
  echo "    --haproxy-image-tag            tag of Docker image containing HAProxy binary (default: 1.8.12-7.4.0-alpine)"
