...
export VOYAGER_IMAGE_TAG=9.0.0
export VOYAGER_HAPROXY_IMAGE_TAG=1.9.4-9.0.0-alpine
...
export SCRIPT_LOCATION="curl -fsSL https://raw.githubusercontent.com/appscode/voyager/9.0.0/"
if [[ "$APPSCODE_ENV" == "dev" ]]; then
  detect_tag
  export SCRIPT_LOCATION="cat "
  export VOYAGER_IMAGE_TAG=$TAG
  export VOYAGER_HAPROXY_IMAGE_TAG=1.9.4-$TAG-alpine
...
show_help() {
  ...
  echo "    --haproxy-image-tag                tag of Docker image containing HAProxy binary (default: 1.9.4-9.0.0-alpine)"
