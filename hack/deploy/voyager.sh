...
export VOYAGER_IMAGE_TAG=${VOYAGER_IMAGE_TAG:-10.0.0}
export VOYAGER_HAPROXY_IMAGE_TAG=1.9.6-10.0.0-alpine
...
export SCRIPT_LOCATION="curl -fsSL https://raw.githubusercontent.com/appscode/voyager/10.0.0/"
