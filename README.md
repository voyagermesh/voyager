...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------|-----------------------------|
| [5.0.0-rc.0](https://github.com/appscode/voyager/releases/tag/5.0.0-rc.0) (uses CRD) | [User Guide](https://github.com/appscode/voyager/tree/5.0.0-rc.0/docs) | 1.7.x+             | 0.12.0+                     |
