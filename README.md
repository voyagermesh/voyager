...
|--------------------------------------------------------------------------------------|----------|--------------------|
| [4.0.0-rc.1](https://github.com/appscode/voyager/releases/tag/4.0.0-rc.1) (uses CRD) |          | 1.7.x+             |
| [3.2.1](https://github.com/appscode/voyager/releases/tag/3.2.1) (uses TPR)           |          | 1.5.x - 1.7.x      |
