...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------|-----------------------------|
| [5.0.0-rc.1](https://github.com/appscode/voyager/releases/tag/5.0.0-rc.1) (uses CRD) | [User Guide](https://github.com/appscode/voyager/tree/5.0.0-rc.1/docs) | 1.7.x+             | 0.12.0+                     |
