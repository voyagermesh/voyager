...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------|-----------------------------|
| [7.0.0-rc.1](https://github.com/appscode/voyager/releases/tag/7.0.0-rc.1) (uses CRD)   | [User Guide](https://appscode.com/products/voyager/7.0.0-rc.1/)         | 1.8.x+             | 0.16.0+ (test/qa clusters)  |
