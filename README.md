...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------|-----------------------------|
| [4.0.0-rc.13](https://github.com/appscode/voyager/releases/tag/4.0.0-rc.13) (uses CRD) | [User Guide](https://github.com/appscode/voyager/tree/4.0.0-rc.13/docs) | 1.7.x+             | 0.12.0+                     |
