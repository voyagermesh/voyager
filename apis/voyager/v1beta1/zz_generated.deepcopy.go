...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_AuthOption, InType: reflect.TypeOf(&AuthOption{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_BasicAuth, InType: reflect.TypeOf(&BasicAuth{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_TLSAuth, InType: reflect.TypeOf(&TLSAuth{})},
...
// DeepCopy_v1beta1_AuthOption is an autogenerated deepcopy function.
func DeepCopy_v1beta1_AuthOption(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*AuthOption)
		out := out.(*AuthOption)
		*out = *in
		...
		if in.TLS != nil {
			...
			*out = new(TLSAuth)
			if err := DeepCopy_v1beta1_TLSAuth(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
// DeepCopy_v1beta1_BasicAuth is an autogenerated deepcopy function.
func DeepCopy_v1beta1_BasicAuth(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*BasicAuth)
		out := out.(*BasicAuth)
		*out = *in
...
func DeepCopy_v1beta1_FrontendRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if in.Auth != nil {
			...
			*out = new(AuthOption)
			if err := DeepCopy_v1beta1_AuthOption(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
// DeepCopy_v1beta1_TLSAuth is an autogenerated deepcopy function.
func DeepCopy_v1beta1_TLSAuth(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*TLSAuth)
		out := out.(*TLSAuth)
		*out = *in
