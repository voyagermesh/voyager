...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_CertificateStorageKubernetes, InType: reflect.TypeOf(&CertificateStorageKubernetes{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_CertificateStorageVault, InType: reflect.TypeOf(&CertificateStorageVault{})},
...
func DeepCopy_v1beta1_CertificateStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if err := DeepCopy_v1beta1_ACMECertificateDetails(&in.Certificate, &out.Certificate, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_v1beta1_CertificateStorageKubernetes is an autogenerated deepcopy function.
func DeepCopy_v1beta1_CertificateStorageKubernetes(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
// DeepCopy_v1beta1_CertificateStorageVault is an autogenerated deepcopy function.
func DeepCopy_v1beta1_CertificateStorageVault(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
