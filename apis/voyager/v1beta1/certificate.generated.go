...
const (
	// ----- content types ----
	codecSelferC_UTF86104 = 1
	codecSelferC_RAW6104  = 0
	// ----- value types used ----
	codecSelferValueTypeArray6104 = 10
	codecSelferValueTypeMap6104   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey6104    = 2
	codecSelfer_containerMapValue6104  = 3
	codecSelfer_containerMapEnd6104    = 4
	codecSelfer_containerArrayElem6104 = 6
	codecSelfer_containerArrayEnd6104  = 7
)

var (
	codecSelferBitsize6104                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr6104 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer6104 struct{}
...
func init() {
	...
	if false { // reference the types, but skip this branch at build/run time
		...
		var v2 pkg3_v1.ObjectReference
		var v3 time.Time
		_, _, _, _ = v0, v1, v2, v3
	}
}
...
func (x *Certificate) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem6104)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF86104, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd6104)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd6104)
			}
		}
	}
}
...
func (x *Certificate) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap6104 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd6104)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray6104 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd6104)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr6104)
		}
	}
}
...
func (x *Certificate) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey6104)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue6104)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *Certificate) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem6104)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("domains"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Domains == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("challengeProvider"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86104, string(x.ACMEUserSecretName))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("acmeUserSecretName"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				yym13 := z.EncBinary()
				_ = yym13
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("storage"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy17 := &x.Storage
					yy17.CodecEncodeSelf(e)
				}
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.Provider))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("provider"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym21 := z.EncBinary()
					_ = yym21
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.Email))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("email"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym24 := z.EncBinary()
					_ = yym24
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("httpProviderIngressReference"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.ProviderCredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("providerCredentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym32 := z.EncBinary()
					_ = yym32
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.ACMEServerURL))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("acmeStagingURL"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym35 := z.EncBinary()
					_ = yym35
					if false {
...
func (x *CertificateSpec) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "httpProviderIngressReference":
			if r.TryDecodeAsNil() {
				x.HTTPProviderIngressReference = pkg3_v1.ObjectReference{}
			} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("http"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.HTTP == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("dns"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.DNS == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("ingress"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy6 := &x.Ingress
...
func (x *HTTPChallengeProvider) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "ingress":
			if r.TryDecodeAsNil() {
				x.Ingress = pkg3_v1.ObjectReference{}
			} else {
				yyv4 := &x.Ingress
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.CredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("credentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("secret"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Secret == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("vault"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Vault == nil {
						r.EncodeNil()
					} else {
...
func (x *SecretStore) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.Name))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("name"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
...
func (x *SecretStore) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *SecretStore) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
...
func (x *SecretStore) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj6 int
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.Prefix))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("prefix"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("creationTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.CreationTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("conditions"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Conditions == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("lastIssuedCertificate"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.LastIssuedCertificate == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("certificateObtained"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86104, string(x.Message))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("message"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				yym17 := z.EncBinary()
				_ = yym17
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("details"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Details == nil {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86104, string(x.Domain))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("domain"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86104, string(x.CertURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("certUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86104, string(x.CertStableURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("certStableUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.AccountRef))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("accountRef"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.SerialNumber))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("serialNumber"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("notBefore"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy9 := &x.NotBefore
					yym10 := z.EncBinary()
					_ = yym10
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("notAfter"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yy14 := &x.NotAfter
					yym15 := z.EncBinary()
					_ = yym15
...
func (x RequestConditionType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferC_UTF86104, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey6104)
				r.EncodeString(codecSelferC_UTF86104, string("type"))
				z.EncSendContainerState(codecSelfer_containerMapValue6104)
				x.Type.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86104, string(x.Reason))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86104, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("reason"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("lastUpdateTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6104)
					r.EncodeString(codecSelferC_UTF86104, string("items"))
					z.EncSendContainerState(codecSelfer_containerMapValue6104)
					if x.Items == nil {
						r.EncodeNil()
					} else {
...
func (x codecSelfer6104) encSliceCertificateCondition(v []CertificateCondition, e *codec1978.Encoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer6104) decSliceCertificateCondition(v *[]CertificateCondition, d *codec1978.Decoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6104) encSliceCertificate(v []Certificate, e *codec1978.Encoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6104) decSliceCertificate(v *[]Certificate, d *codec1978.Decoder) {
	var h codecSelfer6104
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
