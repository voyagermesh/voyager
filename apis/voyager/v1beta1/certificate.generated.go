...
const (
	// ----- content types ----
	codecSelferC_UTF85047 = 1
	codecSelferC_RAW5047  = 0
	// ----- value types used ----
	codecSelferValueTypeArray5047 = 10
	codecSelferValueTypeMap5047   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey5047    = 2
	codecSelfer_containerMapValue5047  = 3
	codecSelfer_containerMapEnd5047    = 4
	codecSelfer_containerArrayElem5047 = 6
	codecSelfer_containerArrayEnd5047  = 7
)

var (
	codecSelferBitsize5047                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr5047 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer5047 struct{}
...
func (x *Certificate) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem5047)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF85047, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd5047)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd5047)
			}
		}
	}
}
...
func (x *Certificate) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap5047 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd5047)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray5047 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd5047)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr5047)
		}
	}
}
...
func (x *Certificate) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey5047)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue5047)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *Certificate) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem5047)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("domains"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Domains == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("challengeProvider"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF85047, string(x.ACMEUserSecretName))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("acmeUserSecretName"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				yym13 := z.EncBinary()
				_ = yym13
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("storage"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy17 := &x.Storage
					yy17.CodecEncodeSelf(e)
				}
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.Provider))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("provider"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym21 := z.EncBinary()
					_ = yym21
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.Email))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("email"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym24 := z.EncBinary()
					_ = yym24
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("httpProviderIngressReference"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.ProviderCredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("providerCredentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym32 := z.EncBinary()
					_ = yym32
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.ACMEServerURL))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("acmeStagingURL"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym35 := z.EncBinary()
					_ = yym35
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("http"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.HTTP == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("dns"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.DNS == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("ingress"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy6 := &x.Ingress
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.CredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("credentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("secret"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Secret == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("vault"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Vault == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.Name))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("name"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.Prefix))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("prefix"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("creationTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.CreationTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("conditions"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Conditions == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("lastIssuedCertificate"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.LastIssuedCertificate == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("certificateObtained"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF85047, string(x.Message))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("message"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				yym17 := z.EncBinary()
				_ = yym17
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("details"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Details == nil {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF85047, string(x.Domain))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("domain"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF85047, string(x.CertURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("certUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF85047, string(x.CertStableURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("certStableUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.AccountRef))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("accountRef"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.SerialNumber))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("serialNumber"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("notBefore"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy9 := &x.NotBefore
					yym10 := z.EncBinary()
					_ = yym10
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("notAfter"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yy14 := &x.NotAfter
					yym15 := z.EncBinary()
					_ = yym15
...
func (x RequestConditionType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferC_UTF85047, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey5047)
				r.EncodeString(codecSelferC_UTF85047, string("type"))
				z.EncSendContainerState(codecSelfer_containerMapValue5047)
				x.Type.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF85047, string(x.Reason))
					}
				} else {
					r.EncodeString(codecSelferC_UTF85047, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("reason"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("lastUpdateTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey5047)
					r.EncodeString(codecSelferC_UTF85047, string("items"))
					z.EncSendContainerState(codecSelfer_containerMapValue5047)
					if x.Items == nil {
						r.EncodeNil()
					} else {
...
func (x codecSelfer5047) encSliceCertificateCondition(v []CertificateCondition, e *codec1978.Encoder) {
	var h codecSelfer5047
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer5047) decSliceCertificateCondition(v *[]CertificateCondition, d *codec1978.Decoder) {
	var h codecSelfer5047
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer5047) encSliceCertificate(v []Certificate, e *codec1978.Encoder) {
	var h codecSelfer5047
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer5047) decSliceCertificate(v *[]Certificate, d *codec1978.Decoder) {
	var h codecSelfer5047
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
