...
const (
	// ----- content types ----
	codecSelferC_UTF86626 = 1
	codecSelferC_RAW6626  = 0
	// ----- value types used ----
	codecSelferValueTypeArray6626 = 10
	codecSelferValueTypeMap6626   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey6626    = 2
	codecSelfer_containerMapValue6626  = 3
	codecSelfer_containerMapEnd6626    = 4
	codecSelfer_containerArrayElem6626 = 6
	codecSelfer_containerArrayEnd6626  = 7
)

var (
	codecSelferBitsize6626                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr6626 = errors.New(`only encoded map or array can be decoded into a struct`)
)
...
func init() {
	...
	if false { // reference the types, but skip this branch at build/run time
		...
		var v4 pkg4_v1.ObjectReference
		var v5 time.Time
...
func (x *Ingress) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem6626)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF86626, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd6626)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd6626)
			}
		}
	}
}
...
func (x *Ingress) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap6626 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd6626)
			} else {
			...
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd6626)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr6626)
		}
	}
}
...
func (x *Ingress) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey6626)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue6626)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *Ingress) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem6626)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey6626)
				r.EncodeString(codecSelferC_UTF86626, string("items"))
				z.EncSendContainerState(codecSelfer_containerMapValue6626)
				if x.Items == nil {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("backend"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.Backend == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("tls"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.TLS == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("frontendRules"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.FrontendRules == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("rules"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.Rules == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("loadBalancerSourceRanges"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.LoadBalancerSourceRanges == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("resources"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy21 := &x.Resources
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("affinity"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.Affinity == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.SchedulerName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("schedulerName"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym28 := z.EncBinary()
					_ = yym28
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("tolerations"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.Tolerations == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("hosts"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.Hosts == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.SecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("secretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("secretRef"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.SecretRef == nil {
						r.EncodeNil()
					} else {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "secretRef":
			if r.TryDecodeAsNil() {
				...
				if x.SecretRef == nil {
					x.SecretRef = new(pkg4_v1.ObjectReference)
				}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("loadBalancer"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy6 := &x.LoadBalancer
	...
	if x == nil {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.Host))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("host"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
		...
		LABEL6:
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("http"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if yyn6 {
						r.EncodeNil()
					} else {
		...
		LABEL9:
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("tcp"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if yyn9 {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("port"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy6 := &x.Port
					yym7 := z.EncBinary()
					_ = yym7
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("noTLS"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym10 := z.EncBinary()
					_ = yym10
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("nodePort"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy14 := &x.NodePort
					yym15 := z.EncBinary()
					_ = yym15
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey6626)
				r.EncodeString(codecSelferC_UTF86626, string("paths"))
				z.EncSendContainerState(codecSelfer_containerMapValue6626)
				if x.Paths == nil {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("alpn"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.ALPN == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.Path))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("path"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("hostNames"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.HostNames == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF86626, string(x.ServiceName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF86626, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("serviceName"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("servicePort"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					yy12 := &x.ServicePort
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("backendRule"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.BackendRule == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("rewriteRule"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.RewriteRule == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey6626)
					r.EncodeString(codecSelferC_UTF86626, string("headerRule"))
					z.EncSendContainerState(codecSelfer_containerMapValue6626)
					if x.HeaderRule == nil {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86626, string(x.APISchema))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6626)
				r.EncodeString(codecSelferC_UTF86626, string("apiSchema"))
				z.EncSendContainerState(codecSelfer_containerMapValue6626)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86626, string(x.Name))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6626)
				r.EncodeString(codecSelferC_UTF86626, string("name"))
				z.EncSendContainerState(codecSelfer_containerMapValue6626)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF86626, string(x.Namespace))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey6626)
				r.EncodeString(codecSelferC_UTF86626, string("namespace"))
				z.EncSendContainerState(codecSelfer_containerMapValue6626)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
...
func (x codecSelfer6626) encSliceIngress(v []Ingress, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) decSliceIngress(v *[]Ingress, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) encSliceIngressTLS(v []IngressTLS, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6626) decSliceIngressTLS(v *[]IngressTLS, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) encSliceFrontendRule(v []FrontendRule, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6626) decSliceFrontendRule(v *[]FrontendRule, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) encSliceIngressRule(v []IngressRule, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6626) decSliceIngressRule(v *[]IngressRule, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) encSlicev1_Toleration(v []pkg4_v1.Toleration, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6626) decSlicev1_Toleration(v *[]pkg4_v1.Toleration, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6626) encSliceHTTPIngressPath(v []HTTPIngressPath, e *codec1978.Encoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer6626) decSliceHTTPIngressPath(v *[]HTTPIngressPath, d *codec1978.Decoder) {
	var h codecSelfer6626
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
