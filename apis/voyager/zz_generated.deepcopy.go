...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_voyager_AuthOption, InType: reflect.TypeOf(&AuthOption{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_voyager_BasicAuth, InType: reflect.TypeOf(&BasicAuth{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_voyager_TLSAuth, InType: reflect.TypeOf(&TLSAuth{})},
...
// DeepCopy_voyager_AuthOption is an autogenerated deepcopy function.
func DeepCopy_voyager_AuthOption(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*AuthOption)
		out := out.(*AuthOption)
		*out = *in
		...
		if in.TLS != nil {
			...
			*out = new(TLSAuth)
			if err := DeepCopy_voyager_TLSAuth(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
// DeepCopy_voyager_BasicAuth is an autogenerated deepcopy function.
func DeepCopy_voyager_BasicAuth(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*BasicAuth)
		out := out.(*BasicAuth)
		*out = *in
...
func DeepCopy_voyager_FrontendRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if in.Auth != nil {
			...
			*out = new(AuthOption)
			if err := DeepCopy_voyager_AuthOption(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
func DeepCopy_voyager_IngressSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if newVal, err := c.DeepCopy(&in.Strategy); err != nil {
			...
			out.Strategy = *newVal.(*v1beta1.DeploymentStrategy)
		}
		return nil
	}
}
...
// DeepCopy_voyager_TLSAuth is an autogenerated deepcopy function.
func DeepCopy_voyager_TLSAuth(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*TLSAuth)
		out := out.(*TLSAuth)
		*out = *in
