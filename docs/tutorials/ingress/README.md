...
url: /products/voyager/5.0.0-rc.6/tutorials/ingress/
aliases:
  - /products/voyager/5.0.0-rc.6/tutorials/ingress/README/
---
...
offer name-based virtual hosting, etc. Users can request ingress by POSTing the Ingress resource to API server.  [Read More](http://kubernetes.io/docs/tutorials/ingress/)
