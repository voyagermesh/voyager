...
$ curl https://raw.githubusercontent.com/appscode/voyager/3.2.0/hack/deploy/without-rbac.yaml \
    | envsubst \
    | kubectl apply -f -

# Install with RBAC roles
$ curl https://raw.githubusercontent.com/appscode/voyager/3.2.0/hack/deploy/with-rbac.yaml \
    | envsubst \
    | kubectl apply -f -
```
...
```
  ...
  -c, --cloud-provider string                 Name of cloud provider
      ...
      --haproxy-image string                  haproxy image name to be run (default "appscode/haproxy:1.7.6-3.2.0")
