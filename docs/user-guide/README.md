...
$ curl https://raw.githubusercontent.com/appscode/voyager/3.1.3/hack/deploy/without-rbac.yaml \
    | envsubst \
    | kubectl apply -f -

# Install with RBAC roles
$ curl https://raw.githubusercontent.com/appscode/voyager/3.1.3/hack/deploy/with-rbac.yaml \
    | envsubst \
    | kubectl apply -f -
```
