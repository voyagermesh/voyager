...
|---------|-------------------------------------------------------------|--------|-------
|  GET    | /apis/networking.appscode.com/v1beta1/namespace/`ns`/ingresss          | LIST   | nil
|  GET    | /apis/networking.appscode.com/v1beta1/namespace/`ns`/ingresss/`name`   | GET    | nil
|  POST   | /apis/networking.appscode.com/v1beta1/namespace/`ns`/ingresss          | CREATE | JSON
|  PUT    | /apis/networking.appscode.com/v1beta1/namespace/`ns`/ingresss/`name`   | UPDATE | JSON
|  DELETE | /apis/networking.appscode.com/v1beta1/namespace/`ns`/ingresss/`name`   | DELETE | nil
