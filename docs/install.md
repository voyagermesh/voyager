...
$ curl https://raw.githubusercontent.com/appscode/voyager/4.0.0-rc.5/hack/deploy/without-rbac.yaml \
    | envsubst \
    | kubectl apply -f -

# Install with RBAC roles
$ curl https://raw.githubusercontent.com/appscode/voyager/4.0.0-rc.5/hack/deploy/with-rbac.yaml \
    | envsubst \
    | kubectl apply -f -
```
