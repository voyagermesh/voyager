...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------|-----------------------------|
| [4.0.0-rc.12](https://github.com/appscode/voyager/releases/tag/4.0.0-rc.12) (uses CRD) | [User Guide](https://github.com/appscode/voyager/tree/4.0.0-rc.12/docs) | 1.7.x+             | 0.12.0+                     |
