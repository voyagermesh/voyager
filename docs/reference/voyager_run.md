...
```
      ...
      --exporter-image-tag string                               Tag of Docker image containing Prometheus exporter (default "v11.0.0")
      --haproxy-image-tag string                                Tag of Docker image containing HAProxy binary (default "1.9.6-v11.0.0-alpine")
