...
```
  ...
  -c, --cloud-provider string                 Name of cloud provider
      ...
      --exporter-sidecar-image string         Docker image containing Prometheus exporter (default "appscode/voyager:5.0.0-rc.7")
      --haproxy-image string                  Docker image containing HAProxy binary (default "appscode/haproxy:1.7.9-5.0.0-rc.7")
