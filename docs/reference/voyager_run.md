...
```
  ...
  -c, --cloud-provider string                 Name of cloud provider
      ...
      --exporter-image-tag string             Tag of Docker image containing Prometheus exporter (default "5.0.0-alpha.0")
      --haproxy-image-tag string              Tag of Docker image containing HAProxy binary (default "1.7.9-5.0.0-alpha.0")
