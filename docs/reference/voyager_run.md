...
```
      ...
      --exporter-image-tag string                               Tag of Docker image containing Prometheus exporter (default "10.0.0")
      --haproxy-image-tag string                                Tag of Docker image containing HAProxy binary (default "1.9.6-10.0.0-alpine")
