...
| haproxy-image| appscode/haproxy:1.7.9-5.0.0-alpha.0 | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/5.0.0-alpha.0/apis/voyager/v1beta1/crds.yaml
```
