...
| haproxy-image| appscode/haproxy:1.8.8-7.0.0-rc.3-alpine | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.0.0-rc.3/apis/voyager/v1beta1/crds.yaml
```
