...
| haproxy-image| appscode/haproxy:1.8.12-8.0.0-alpine | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/8.0.0/apis/voyager/v1beta1/crds.yaml
```
