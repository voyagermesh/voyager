...
| haproxy-image| appscode/haproxy:1.8.9-7.1.1-alpine | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.1.1/apis/voyager/v1beta1/crds.yaml
```
