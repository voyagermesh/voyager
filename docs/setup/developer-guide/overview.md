...
| haproxy-image| appscode/haproxy:1.9.6-v11.0.0-alpine | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/v11.0.0/apis/voyager/v1beta1/crds.yaml
```
