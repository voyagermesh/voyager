...
| haproxy-image| appscode/haproxy:1.8.12-7.2.0-alpine | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.2.0/apis/voyager/v1beta1/crds.yaml
```
