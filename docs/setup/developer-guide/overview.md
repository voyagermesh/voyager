...
| haproxy-image| appscode/haproxy:1.7.10-6.0.0-rc.1 | HAProxy image name to run |
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/6.0.0-rc.1/apis/voyager/v1beta1/crds.yaml
```
