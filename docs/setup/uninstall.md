...
url: /products/voyager/5.0.0-rc.9/getting-started/uninstall/
aliases:
  - /products/voyager/5.0.0-rc.9/uninstall/
---
...
```console
$ curl -fsSL https://raw.githubusercontent.com/appscode/voyager/5.0.0-rc.9/hack/deploy/uninstall.sh | bash
