...
url: /products/voyager/5.0.0-rc.7/getting-started/uninstall/
aliases:
  - /products/voyager/5.0.0-rc.7/uninstall/
---
...
```console
$ curl -fsSL https://raw.githubusercontent.com/appscode/voyager/5.0.0-rc.7/hack/deploy/uninstall.sh | bash
