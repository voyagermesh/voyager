...
url: /products/voyager/5.0.0-rc.6/developer-guide/
aliases:
  - /products/voyager/5.0.0-rc.6/developer-guide/README/
---
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/5.0.0-rc.6/apis/voyager/v1beta1/crds.yaml
```
