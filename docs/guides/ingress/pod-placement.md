...
```console
$ curl -fSsL https://raw.githubusercontent.com/appscode/voyager/10.0.0/docs/examples/ingress/pod-placement/deploy-servers.sh | bash
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/10.0.0/docs/examples/ingress/pod-placement/ingress-w-node-selector.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/10.0.0/docs/examples/ingress/pod-placement/ingress-w-pod-anti-affinity.yaml
```
...
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/10.0.0/docs/examples/ingress/pod-placement/ingress-w-toleration.yaml
```
