...
```console
$ kubectl create -f https://raw.githubusercontent.com/appscode/voyager/8.0.1/docs/examples/monitoring/coreos-operator/demo-0.yaml
...
```console
$ kubectl create -f https://raw.githubusercontent.com/appscode/voyager/8.0.1/docs/examples/monitoring/coreos-operator/demo-1.yaml
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/8.0.1/docs/examples/monitoring/coreos-operator/ing.yaml
