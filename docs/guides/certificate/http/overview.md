...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/5.0.0-alpha.0/docs/examples/certificate/http/ing.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/5.0.0-alpha.0/docs/examples/certificate/http/crt.yaml
```
