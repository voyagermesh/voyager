...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.4.0/docs/examples/certificate/http/ing.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.4.0/docs/examples/certificate/http/crt.yaml
```
