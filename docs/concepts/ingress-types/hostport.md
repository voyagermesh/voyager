...
```console
curl -fsSL https://raw.githubusercontent.com/appscode/voyager/7.1.1/docs/examples/ingress/types/hostport/deploy-servers.sh | bash
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.1.1/docs/examples/ingress/types/hostport/ing.yaml
```
...
$ curl -vv 127.1.1.1 -H "Host: web.example.com"
> GET / HTTP/1.1
...
```console
$ curl -vv 127.1.1.1 -H "Host: app.example.com"
> GET / HTTP/1.1
...
tcp        0      0 127.1.1.1:2380          0.0.0.0:*               LISTEN
```
