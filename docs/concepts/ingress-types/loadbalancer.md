...
```console
curl -fsSL https://raw.githubusercontent.com/appscode/voyager/7.0.0-rc.1/docs/examples/ingress/types/loadbalancer/deploy-servers.sh | bash
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.0.0-rc.1/docs/examples/ingress/types/loadbalancer/ing.yaml
```
