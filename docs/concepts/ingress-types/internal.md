...
```console
curl -fsSL https://raw.githubusercontent.com/appscode/voyager/7.1.0/docs/examples/ingress/types/internal/deploy-servers.sh | bash
...
```console
kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/7.1.0/docs/examples/ingress/types/internal/ing.yaml
```
