...
```console
curl -fsSL https://raw.githubusercontent.com/appscode/voyager/5.0.0-rc.11/docs/examples/ingress/types/internal/deploy-servers.sh | bash
...
- Now, create an Ingress object running `kubectl apply -f https://raw.githubusercontent.com/appscode/voyager/5.0.0-rc.11/docs/examples/ingress/types/internal/ing.yaml`. Please note the annotaiton on ingress:
