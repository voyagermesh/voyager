...
url: /products/voyager/5.0.0-rc.7/tasks/ingress/
aliases:
  - /products/voyager/5.0.0-rc.7/tasks/ingress/README/
---
...
offer name-based virtual hosting, etc. Users can request ingress by POSTing the Ingress resource to API server.  [Read More](http://kubernetes.io/docs/tasks/ingress/)
...
**Features**
  - [HTTP](/docs/tasks/ingress/single-service.md) and [TCP](/docs/tasks/ingress/tcp.md) loadbalancing,
  - [TLS Termination](/docs/tasks/ingress/tls.md),
  - Multi-cloud support,
  - [Name and Path based virtual hosting](/docs/tasks/ingress/named-virtual-hosting.md),
  - [Cross namespace routing support](/docs/tasks/ingress/named-virtual-hosting.md#cross-namespace-traffic-routing),
  - [URL and Request Header Re-writing](/docs/tasks/ingress/header-rewrite.md),
  - [Wildcard Name based virtual hosting](/docs/tasks/ingress/named-virtual-hosting.md),
  - Persistent sessions, Loadbalancer stats.
  - [Route Traffic to StatefulSet Pods Based on Host Name](/docs/tasks/ingress/statefulset-pod.md)
  - [Weighted Loadbalancing for Canary Deployment](/docs/tasks/ingress/weighted.md)
  - [Customize generated HAProxy config via BackendRule](/docs/tasks/ingress/backend-rule.md) (can be used for [http rewriting](https://www.haproxy.com/doc/aloha/7.0/haproxy/http_rewriting.html), add [health checks](https://www.haproxy.com/doc/aloha/7.0/haproxy/healthchecks.html), etc.)
  - [Add Custom Annotation to LoadBalancer Service and Pods](/docs/tasks/ingress/annotations.md)
  - [Supports Loadbalancer Source Range](/docs/tasks/ingress/source-range.md)
  - [Supports redirects/DNS resolution for `ExternalName` type service](/docs/tasks/ingress/external-svc.md)
  - [Expose HAProxy stats for Prometheus](/docs/tasks/ingress/stats-and-prometheus.md)
  - [Supports AWS certificate manager](/docs/tasks/ingress/aws-cert-manager.md)
  - [Scale load balancer using HorizontalPodAutoscaling](/docs/tasks/ingress/replicas-and-autoscaling.md)
  - [Configure Custom Timeouts for HAProxy](/docs/tasks/ingress/configure-timeouts.md)
  - [Custom port for HTTP](/docs/tasks/ingress/custom-http-port.md)
  - [Specify NodePort](/docs/tasks/ingress/node-port.md)
  - [Backend TLS](/docs/tasks/ingress/backend-tls.md)
  - [Configure Options](/docs/tasks/ingress/configure-options.md)
  - [Using Custom HAProxy Templates](/docs/tasks/ingress/custom-templates.md)
  - [Configure Basic Auth for HTTP Backends](/docs/tasks/ingress/basic-auth.md)
  - [Configure Sticky session to Backends](/docs/tasks/ingress/sticky-session.md)
  - [Apply Frontend Rules](/docs/tasks/ingress/frontend-rule.md)
  - [Supported Annotations](/docs/tasks/ingress/ingress-annotations.md)
