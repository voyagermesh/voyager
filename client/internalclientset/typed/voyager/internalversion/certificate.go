...
import (
	...
	scheme "github.com/appscode/voyager/client/internalclientset/scheme"
...
type CertificateInterface interface {
	Create(*voyager.Certificate) (*voyager.Certificate, error)
	Update(*voyager.Certificate) (*voyager.Certificate, error)
	UpdateStatus(*voyager.Certificate) (*voyager.Certificate, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*voyager.Certificate, error)
	List(opts v1.ListOptions) (*voyager.CertificateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *voyager.Certificate, err error)
...
func newCertificates(c *VoyagerClient, namespace string) *certificates {
	return &certificates{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *certificates) Get(name string, options v1.GetOptions) (result *voyager.Certificate, err error) {
	result = &voyager.Certificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *certificates) List(opts v1.ListOptions) (result *voyager.CertificateList, err error) {
	result = &voyager.CertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("certificates").
...
func (c *certificates) Create(certificate *voyager.Certificate) (result *voyager.Certificate, err error) {
	result = &voyager.Certificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("certificates").
...
func (c *certificates) Update(certificate *voyager.Certificate) (result *voyager.Certificate, err error) {
	result = &voyager.Certificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("certificates").
...
func (c *certificates) UpdateStatus(certificate *voyager.Certificate) (result *voyager.Certificate, err error) {
	result = &voyager.Certificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("certificates").
...
func (c *certificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *voyager.Certificate, err error) {
	result = &voyager.Certificate{}
